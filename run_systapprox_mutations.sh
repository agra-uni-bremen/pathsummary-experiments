	...
	do
	  ...
	  do
            ...
            do
              ...
              do
                tests+=("sysc_syst_${width}_${height}_${size}_approx_${interval}_${segment}_${iteration}_FAULT${mutation}#${funcnum}")
              done
              for mutation in "${mutations_systolic[@]}"
              do
                tests+=("sysc_syst_${width}_${height}_${size}_FAULT${mutation}_approx_${interval}_${segment}_${iteration}#${funcnum}")
	      done
	    done
          done
        done
