...
widths=(2) # 3 4)
heights=(2)
matrix_sizes=(2) # 1 2 3)
# approx
intervals=(1) #2 4 8)
segments=(8 128 1024)
iterations=(1) # 2 4) #4
functions=(gaussian) # sinc tanh sigmoid silu cos exp softsign)
  ...
  do
    ...
    do
	  ...
	  do
	    ...
	    do
              tests+=("sysc_syst_${width}_${height}_${m_size}_approx_fp_${interval}_${segment}_${iteration}#${funcnum}")
	    done
	  done
        done
      done
