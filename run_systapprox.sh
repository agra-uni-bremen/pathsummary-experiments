...
# Systolic
heights=(2) # 3 4) # 16 32 64 128
widths=(2) # 3 4)
matrix_sizes=(2) #1 2 3) # 4)
# Approx
intervals=() #4096 8192) #1024 16384 32768)
segments=(64) #256 512 2048)
iterations=(1) # 4 8)
functions=(f2) #f1
  ...
  do
    ...
    do
	  ...
	  do
	    ...
	    do
            	tests+=("sysc_syst_${width}_${height}_${m_size}_approx_${interval}_${segment}_${iteration}#${funcnum}")
	    done
	  done
        done
      done
